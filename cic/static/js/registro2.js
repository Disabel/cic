...
/* SI O NO DE OTRA CERTIFICACION CIC */
  $('#siotrocic').on('click',function(){
  	$('.otracic').removeClass('notShow');
        });
  $('#nootrocic').on('click',function(){
  	$('.otracic').addClass('notShow');
        });
  $('#siotro').on('click',function(){
  	$('.otrolugar').removeClass('notShow');
        });
  $('#nootro').on('click',function(){
  	$('.otrolugar').addClass('notShow');
        });  
