...
SECRET_KEY = 'ssnwl-*!p(uj(1yq%zedbhf%d8oiwuk)n+h+e&57a_f=y+-3_r'
...
ADMINS = (
    ('reston', 'restonjd@gmail.com'),
    ('disabel', 'dianaichavez2@gmail.com'),
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cic_db',                      # Or path to database file if using sqlite3.
